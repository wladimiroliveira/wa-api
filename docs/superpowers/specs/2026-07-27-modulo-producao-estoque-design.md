...
O núcleo de custo/precificação está pronto, mas `Supply` só guarda dados de compra/custo — **não tem saldo de estoque**. Este módulo introduz o estoque de insumos e o registro de produção, atacando a segunda dor levantada pela empresa: *"perco insumo/desperdício, não sei o que tenho em estoque"*.
